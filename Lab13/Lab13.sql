...
grant create tablespace, drop tablespace to U1_RNA_PDB;
alter user U1_RNA_PDB quota unlimited on t1;
alter user U1_RNA_PDB quota unlimited on t2;
alter user U1_RNA_PDB quota unlimited on t3;
alter user U1_RNA_PDB quota unlimited on t4;
